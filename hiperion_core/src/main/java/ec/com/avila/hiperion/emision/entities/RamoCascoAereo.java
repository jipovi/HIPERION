...
public class RamoCascoAereo implements Serializable {
	...
	@Column(name="deduc_siniestro_qereo")
	private BigDecimal deducSiniestroQereo;
	...
	public BigDecimal getDeducSiniestroQereo() {
		return this.deducSiniestroQereo;
	}

	public void setDeducSiniestroQereo(BigDecimal deducSiniestroQereo) {
		this.deducSiniestroQereo = deducSiniestroQereo;
	}
