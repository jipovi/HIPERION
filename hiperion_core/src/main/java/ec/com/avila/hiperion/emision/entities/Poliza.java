...
public class Poliza implements Serializable {
	...
	@OneToMany(mappedBy="poliza")
	private List<RamoCesanteRoturaMaq> ramoCesanteRoturaMaqs;
	...
	@OneToMany(mappedBy="poliza")
	private List<RamoLucroCesanteIncendio> ramoLucroCesanteIncendios;
	...
	public List<RamoCesanteRoturaMaq> getRamoCesanteRoturaMaqs() {
		return this.ramoCesanteRoturaMaqs;
	}

	public void setRamoCesanteRoturaMaqs(List<RamoCesanteRoturaMaq> ramoCesanteRoturaMaqs) {
		this.ramoCesanteRoturaMaqs = ramoCesanteRoturaMaqs;
	}

	public RamoCesanteRoturaMaq addRamoCesanteRoturaMaq(RamoCesanteRoturaMaq ramoCesanteRoturaMaq) {
		getRamoCesanteRoturaMaqs().add(ramoCesanteRoturaMaq);
		ramoCesanteRoturaMaq.setPoliza(this);

		return ramoCesanteRoturaMaq;
	}

	public RamoCesanteRoturaMaq removeRamoCesanteRoturaMaq(RamoCesanteRoturaMaq ramoCesanteRoturaMaq) {
		getRamoCesanteRoturaMaqs().remove(ramoCesanteRoturaMaq);
		ramoCesanteRoturaMaq.setPoliza(null);
	...
	public List<RamoLucroCesanteIncendio> getRamoLucroCesanteIncendios() {
		return this.ramoLucroCesanteIncendios;
	}

	public void setRamoLucroCesanteIncendios(List<RamoLucroCesanteIncendio> ramoLucroCesanteIncendios) {
		this.ramoLucroCesanteIncendios = ramoLucroCesanteIncendios;
	}

	public RamoLucroCesanteIncendio addRamoLucroCesanteIncendio(RamoLucroCesanteIncendio ramoLucroCesanteIncendio) {
		getRamoLucroCesanteIncendios().add(ramoLucroCesanteIncendio);
		ramoLucroCesanteIncendio.setPoliza(this);

		return ramoLucroCesanteIncendio;
	}

	public RamoLucroCesanteIncendio removeRamoLucroCesanteIncendio(RamoLucroCesanteIncendio ramoLucroCesanteIncendio) {
		getRamoLucroCesanteIncendios().remove(ramoLucroCesanteIncendio);
		ramoLucroCesanteIncendio.setPoliza(null);
