...
@Stateless
public class RamoAgropecuarioDaoImpl implements RamoAgropecuarioDao {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see ec.com.avila.hiperion.dao.RamoAgropecuarioDao#guardarAgropecuario(ec.com.avila.hiperion.emision.entities.RamoAgropecuario)
	 */
	@Override
	public Integer guardarAgropecuario(RamoAgropecuario ramoAgropecuario) throws HiperionException {
		try {

			em.persist(ramoAgropecuario);
			
			return ramoAgropecuario.getIdAgropecuario();

		} catch (Exception e) {
			log.error("Error no se pudo guardar el ramoAgropecuario ", e);
