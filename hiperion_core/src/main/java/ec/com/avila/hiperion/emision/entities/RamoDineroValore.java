...
public class RamoDineroValore implements Serializable {
	...
	@Column(name="minimo_embarque_dinero")
	private BigDecimal minimoEmbarqueDinero;
	...
	public BigDecimal getMinimoEmbarqueDinero() {
		return this.minimoEmbarqueDinero;
	}

	public void setMinimoEmbarqueDinero(BigDecimal minimoEmbarqueDinero) {
		this.minimoEmbarqueDinero = minimoEmbarqueDinero;
	}
