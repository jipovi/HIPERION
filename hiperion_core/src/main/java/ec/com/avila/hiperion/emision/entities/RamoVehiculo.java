...
public class RamoVehiculo implements Serializable {
	...
	@Column(name="tipo_vh")
	private Integer tipoVh;

	@Column(name="uso_vh")
	private Integer usoVh;
	...
	public Integer getClaseVh() {
		return this.claseVh;
	}

	public void setClaseVh(Integer claseVh) {
	...
	public Integer getModeloVh() {
		return this.modeloVh;
	}

	public void setModeloVh(Integer modeloVh) {
	...
	public Integer getTipoVh() {
		return this.tipoVh;
	}

	public void setTipoVh(Integer tipoVh) {
		this.tipoVh = tipoVh;
	}

	public Integer getUsoVh() {
		return this.usoVh;
	}

	public void setUsoVh(Integer usoVh) {
		this.usoVh = usoVh;
	}
