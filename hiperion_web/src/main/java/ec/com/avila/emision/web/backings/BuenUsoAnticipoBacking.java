...
public class BuenUsoAnticipoBacking implements Serializable {
	 ...
	 * 
	 * <b>
	 * Permite guardar datos en la base de datos del Ramo Buen Uso Anticipo
	 * </b>
	 * <p>[Author: Franklin Pozo, Date: 17/08/2014]</p>
	 *
	 * @throws HiperionException
	 */
	public void guardarRamo() throws HiperionException {
		...
		//buenUsoAnt.setSector(ramoBuenUsoAnticipoBean.getSector());
		//buenUsoAnt.setObjetoAsegurado(ramoBuenUsoAnticipoBean.getObjetoAsegurado());
		
		try{
			
			ramoBuenUsoAnticipoService.guardarRamoBuenUsoAnticipo(buenUsoAnt);
			MessagesController.addInfo(null, HiperionMensajes.getInstancia().getString("hiperion.mensaje.exito.buenUsoAnticipo"));
		
		}catch(HiperionException e){
		
			log.error("Error al momento de guardar el ramo Buen Uso de Anticipo",e);
			MessagesController.addError(null, HiperionMensajes.getInstancia().getString("hiperion.mensaje.error.buenUsoAnticipo"));
	...
	/**
	 * @param ramoBuenUsoAnticipoBean the ramoBuenUsoAnticipoBean to set
	 */
