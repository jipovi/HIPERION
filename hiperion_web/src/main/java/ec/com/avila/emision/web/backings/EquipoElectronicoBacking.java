...
public class EquipoElectronicoBacking implements Serializable {
	...
	/**
	 * 
	 * <b> Permite guardar datos en el Ramo Equipo Electronico e la bade de datos </b>
	 * <p>
	...
	public void guardarRamo() throws HiperionException {
		...
		/*equipoElectronico.setTasaFijos(ramoEquipoElectronicoBean.getTasaFijos());
		equipoElectronico.setTasaPortadoresExternos(ramoEquipoElectronicoBean.getTasaDatos());
		equipoElectronico.setTasaIncrementoCosto(ramoEquipoElectronicoBean.getTasaOperacion());
		equipoElectronico.setTasaPortatiles(ramoEquipoElectronicoBean.getTasaPortatiles());
		equipoElectronico.setTasaCelulares(ramoEquipoElectronicoBean.getTasaCelulares());
		equipoElectronico.setTasaHurto(ramoEquipoElectronicoBean.getTasaHurto());
		equipoElectronico.setTasaOtros(ramoEquipoElectronicoBean.getTasaOtros());*/

		try {
			ramoEquipoElectronicoService.guardarRamoEquipoElectronico(equipoElectronico);
			MessagesController.addInfo(null, HiperionMensajes.getInstancia().getString("hiperion.mensaje.exito.equipoElectronico"));
		} catch (HiperionException e) {
			log.error("Error al momento de guardar el Ramo Equipo Electronico ", e);
			MessagesController.addError(null, HiperionMensajes.getInstancia().getString("hiperion.mensaje.error.equipoElectronico"));
	...
	/**
	 * @param ramoEquipoElectronicoBean the ramoEquipoElectronicoBean to set
	 */
