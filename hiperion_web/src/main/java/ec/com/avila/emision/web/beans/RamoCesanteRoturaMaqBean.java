...
public class RamoCesanteRoturaMaqBean implements Serializable {
	...
	private static final ArrayList<ObjetoAseguradoCesanteRoturaMaqDTO> orderList = new ArrayList<ObjetoAseguradoCesanteRoturaMaqDTO>();
	 ...
	 */
	public ArrayList<ObjetoAseguradoCesanteRoturaMaqDTO> getOrderlist() {
		return orderList;
	}
	...
	public void onCancel(RowEditEvent event) {
		...
		FacesContext.getCurrentInstance().addMessage(null, msg);
		orderList.remove((ObjetoAseguradoCesanteRoturaMaqDTO) event.getObject());
	}
