...
public class BuenaCalidadMaterialesBacking implements Serializable {
	...
	public void guardarRamo() throws HiperionException {
		...
		//buenaCalidadMateriales.setSector(ramoBuenaCalMatBean.getSector());
		//buenaCalidadMateriales.setObjetoAsegurado(ramoBuenaCalMatBean.getObjetoAsegurado());

		try {

			ramoBuenaCalMatService.guardarRamoBuenaCalMat(buenaCalidadMateriales);
			MessagesController.addInfo(null, HiperionMensajes.getInstancia().getString("hiperion.mensaje.exito.buenaCalidadmateriales"));

		} catch (HiperionException e) {

			log.error("Error al momento de guardar el ramo Buena Calidad de materiales", e);
			MessagesController.addError(null, HiperionMensajes.getInstancia().getString("hiperion.mensaje.error.buenaCalidadMateriales"));
