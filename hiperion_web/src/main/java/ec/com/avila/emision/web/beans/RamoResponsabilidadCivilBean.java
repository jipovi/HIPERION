...
public class RamoResponsabilidadCivilBean implements Serializable {
	...
	private static final ArrayList<ObjetoAseguradoResponsabilidadDTO> orderList = new ArrayList<ObjetoAseguradoResponsabilidadDTO>();
	 ...
	 */
	public ArrayList<ObjetoAseguradoResponsabilidadDTO> getOrderlist() {
		return orderList;
	}
	...
	public String addAction() {
		ObjetoAseguradoResponsabilidadDTO orderitem = new ObjetoAseguradoResponsabilidadDTO(this.numeroItem, this.ubicacionRiesgo,this.descripcionObjeto);
	...
	public void onCancel(RowEditEvent event) {
		...
		FacesContext.getCurrentInstance().addMessage(null, msg);
		orderList.remove((ObjetoAseguradoResponsabilidadDTO) event.getObject());
	}
