...
public class EquipoMaquinariaBacking implements Serializable {
	...
	/**
	 * @param ramoEquipoMaquinaraBean the ramoEquipoMaquinaraBean to set
	 */
	...
	public void guardarRamo()throws HiperionException {
		...
		//ramoEquipoMaquinaria.setMinimoAsegurado(ramoEquipoMaquinaraBean.getMinimoAsegurado());
		
		try{
			ramoEquipoMaquinariaService.guardarRamoEquipoMaquinaria(ramoEquipoMaquinaria);
			MessagesController.addInfo(null,HiperionMensajes.getInstancia().getString("hiperion.mensaje.exito.equipoMaquinaria"));
		}catch (HiperionException e){
			log.error("Error al guardar ramo Equipo y Maquinaria",e);
			MessagesController.addError(null, HiperionMensajes.getInstancia().getString("hiperion.mensaje.error.equipoMaquinaria"));
