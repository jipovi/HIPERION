...
public class VehiculosBacking implements Serializable {
	...
	public void guardarRamo() throws HiperionException {
		...
		try {
			...
			MessagesController.addInfo(null, HiperionMensajes.getInstancia().getString("hiperion.mensaje.exito.vehiculos"));
		} catch (HiperionException e) {
			log.error("Error al momento de guardar el Ramo Vehículos", e);
			MessagesController.addError(null, HiperionMensajes.getInstancia().getString("hiperion.mensaje.error.vehiculos"));
