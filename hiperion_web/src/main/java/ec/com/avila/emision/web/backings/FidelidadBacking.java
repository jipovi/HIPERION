...
public class FidelidadBacking implements Serializable {
	...
	public void guardarRamo() throws HiperionException {
		...
		try{
			ramoFidelidadService.guardarRamoFidelidad(ramoFidelidad);
			MessagesController.addInfo(null, HiperionMensajes.getInstancia().getString("hiperion.mensaje.exito.fidelidad"));
		}catch(HiperionException e){
			log.error("Error al momento de guardar el Ramo Fidelidad",e);
			MessagesController.addError(null, HiperionMensajes.getInstancia().getString("hiperion.mensaje.error.fidelidad"));
	...
	/**
	 * @param ramoFidelidadBean the ramoFidelidadBean to set
	 */
