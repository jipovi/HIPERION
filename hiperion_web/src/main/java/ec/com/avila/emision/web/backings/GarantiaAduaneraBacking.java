...
public class GarantiaAduaneraBacking implements Serializable {
	...
	public void guardarRamo() throws HiperionException {
		...
		//ramoGarantiaAduanera.setObjetoAsegurado(ramoGarantiaAduaneraBean.getObjetoAsegurado());
		//ramoGarantiaAduanera.setValorPoliza(ramoGarantiaAduaneraBean.getValorPoliza());
		//ramoGarantiaAduanera.setTipoContragarantia(ramoGarantiaAduaneraBean.getTipoContragarantia());

		try {
			ramoGarantiaAduaneraService.guardarRamoGarantiaAduanera(ramoGarantiaAduanera);
			MessagesController.addInfo(null, HiperionMensajes.getInstancia().getString("hiperion.mensaje.exito.garantiaAduanera"));
		} catch (HiperionException e) {
			log.error("Error al momento de guardar el Ramo Garantia Aduanera", e);
			MessagesController.addError(null, HiperionMensajes.getInstancia().getString("hiperion.mensaje.error.garantiaAduanera"));
