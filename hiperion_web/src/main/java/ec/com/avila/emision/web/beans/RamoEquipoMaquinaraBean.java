...
public class RamoEquipoMaquinaraBean implements Serializable {
	...
	private static final ArrayList<ObjetoAseguradoEquipoMaqDTO> orderList = new ArrayList<ObjetoAseguradoEquipoMaqDTO>();
	 ...
	 */
	public ArrayList<ObjetoAseguradoEquipoMaqDTO> getOrderlist() {
		return orderList;
	}
	...
	public void onCancel(RowEditEvent event) {
		...
		FacesContext.getCurrentInstance().addMessage(null, msg);
		orderList.remove((ObjetoAseguradoEquipoMaqDTO) event.getObject());
	}
