...
public class CumplimientoContratoBacking implements Serializable {
	...
	public void guardarRamo() throws HiperionException {
		...
		//cumplimientoContrato.setObjetoAsegurado(ramoCumplimientoContratoBean.getObjetoAsegurado());
		//cumplimientoContrato.setValorAsegurado(ramoCumplimientoContratoBean.getValorAsegurado());

		try {
			ramoCumplimientoContratoService.guardarRamoCumplimientoContrato(cumplimientoContrato);
			MessagesController.addInfoSession(null, HiperionMensajes.getInstancia().getString("Hiperion.mensaje.error.cumplimientoContrato"));
		} catch (HiperionException e) {
			log.error("Error al momento de guardar el Ramo Cumplimiento de contrato", e);
			MessagesController.addError(null, HiperionMensajes.getInstancia().getString("hiperion.mensaje.error.cumplimientoContrato"));
