...
public class ContactoDTO {
	 ...
	 */
	public ContactoDTO(String nombre, String apellidoMaterno, String apellidoPaterno, String identificacion, String cargo, String email, String telefonoContacto) {
		super();
		this.nombre = nombre;
