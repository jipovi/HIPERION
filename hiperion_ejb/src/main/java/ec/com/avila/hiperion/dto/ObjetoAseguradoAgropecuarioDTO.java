...
public class ObjetoAseguradoAgropecuarioDTO implements Serializable {
	...
	public ObjetoAseguradoAgropecuarioDTO(Integer item, String nombre, Integer sexo, String raza, String color, Integer edad, BigDecimal montoAsegurado, BigDecimal tasa) {
		this.item = item;
		this.nombre = nombre;
		this.sexo = sexo;
		this.raza = raza;
